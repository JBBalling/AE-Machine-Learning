"""
Create a regression tree to predict the barrels per day (bpd) 
produced by a particular drilling site, given some porosity,
gamma, sonic and density values.
"""
...
def mse(array):
    avg = get_avg(array)
    return sum([(element-avg)**2 for element in array])/len(array)
